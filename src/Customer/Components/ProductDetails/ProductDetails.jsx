      ...
      <div className="pt-6">
        ...
        <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
          <div className="lg:col-span-2 ">
            <h1 className="text-lg lg:text-xl font-semibold text-gray-900 sm:text-3xl">Universalfit</h1>
            <p className='text-lg lg:text-xl text-gray-900 opacity-60 pt-1'>Solid Women White T short </p>
          </div>
            ...
            <div className='border p-5'>
                <Grid container spacing={7}>
                    ...
                    <Grid item xs={5}>
                      ...
                      <div className='flex center-item space-x-3'>
                        <Rating name='read-only' value={4.5} precision={0.5} readOnly/>
                        <p className='opacity-60'>594809 Ratings</p>
                      </div>
                      <Box className='mt-5 space-y-3'>
                        ...
                        <Grid container alignItems="center" gap={2}>
                          ...
                          <Grid item xs={7}>
                            <LinearProgress sx={{bgcolor:"#d0d0d0",borderRadius:4,height:7}} variant='determinate' value={40} className='bg-yellow-300'/>
                          </Grid>
                        </Grid>
